...
/**
 * @author zxc Dec 8, 2014 11:44:22 PM
 */
public class UserSearchQuery implements SearchQuery, Serializable {

    private static final long serialVersionUID = -2451830592740853972L;
    ...
    public UserSearchQuery(List<String> wordList, SortSearchEnum sort, TimeSearchEnum time) {
