...
import com.mmj.app.common.core.WebResponseWrapper;
import com.mmj.app.common.pipeline.PipelineHandler;
import com.mmj.app.common.pipeline.PipelineMap;
import com.mmj.app.common.pipeline.PipelineResult;
import com.mmj.app.common.pipeline.PipelineType;
import com.mmj.app.common.pipeline.PipelineValvesMapper;

/**
 * @author zxc Nov 27, 2014 2:04:51 PM
 */
public class PipelineHandlerInterceptor extends HandlerInterceptorAdapter {
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception {
        ...
        PipelineResult result = pipelineHandler.doPreHandlePipelineValues(request, webResponseWrapper, map,
                                                                          preHandlePipelineValves, handler);
