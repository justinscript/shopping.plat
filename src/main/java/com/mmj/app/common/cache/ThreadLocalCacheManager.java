 ...
 */
package com.mmj.app.common.cache;
...
import com.mmj.app.common.cache.ThreadContextCache.ThreadLocalCallback;
...
public class ThreadLocalCacheManager {
    ...
    private static Map<String, Object> regist(Class<?> typeOfCache) {
        ...
        if (map == null) {
            logger.error("Create Map for {}'s musn ThreadLocalCache Failed!!", typeOfCache.getName());
        }
        return map;
    }
}
